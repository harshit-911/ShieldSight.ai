...
export class ToxicityClassifier implements TextClassifier {
  ...
  async classify(textBlock: DiscoveredTextBlock): Promise<ToxicityResult> {
    ...
    const sexualRegex = /\b(nude|naked|adult|nsfw|porn|pornography|sex|sexual|erotic|orgasm|explicit|cum|intercourse|penis|vagina|pussy|boobs|tits|cock|dick|bikini|escort|hentai|strip|topless|lauda|loda|laund|lodu|choot|bhosada)[a-z]*\b/i;
